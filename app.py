...
def graphical_operation_postamble(tree, senttok, cgel_tree_terminals):
	treeobj = ActivedopTree(tree, senttok)
...
def newlabel():
	...
	senttok = treeobj.senttok
	ptree = brackettree(writediscbrackettree(tree, senttok))[0]
	treeobj = ActivedopTree(ptree, senttok)
	treeobj, treestr, link, msg = graphical_operation_postamble(treeobj.ptree, treeobj.senttok, cgel_tree_terminals) 
	if error == '':
